...
//when you type an item into the search field, it will send that item to the end of the url in to fetch.
let findMe = '';
...
//Once we have converted the data, we want to extract what we want and add it to the webpage
